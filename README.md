...
- A Windows 95-inspired GUI built with Python and Tkinter
- An MS-DOS-style text adventure embedded in the OS
- Multiple storylines with branching paths and endings (death, survival, solving the mystery)
- Save system powered by SQLite3 (with proper relational structure: primary & foreign keys)
- In-game performance analysis at the end of each run
- Original GUI images and icons made in Photoshop
...
Playable build will be available on Itch.io after final polish.
